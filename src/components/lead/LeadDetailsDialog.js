                ...
                <Grid container spacing={2}>
                  <Grid item xs={12}>
                    <TextField
                      fullWidth
                      label="Full Name"
                      value={editing ? editedLead.name || "" : lead.name || ""}
                      onChange={(e) =>
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={6}>
                    <FormControl fullWidth>
                      ...
                      <Select
                        value={
                          editing ? editedLead.status || "" : lead.status || ""
                        }
                        label="Status"
                        onChange={(e) =>
                  ...
                  <Grid item xs={12} sm={6}>
                    <FormControl fullWidth>
                      ...
                      <Select
                        value={
                          editing ? editedLead.source || "" : lead.source || ""
                        }
                        label="Source"
                        onChange={(e) =>
                  ...
                  <Grid item xs={12}>
                    <TextField
                      ...
                      value={
                        editing ? editedLead.program || "" : lead.program || ""
                      }
                      onChange={(e) =>
