...
export const canViewLeadStage = (role, stage) => {
  ...
  const statusToStageMap = {
    ...
    // Contacted status mappings
    CONTACTED: LEAD_STAGES.INTERESTED,
    CONTACTED_VIA_WHATSAPP: LEAD_STAGES.INTERESTED,
    CONTACTED_VIA_PHONE: LEAD_STAGES.INTERESTED,
    CONTACTED_VIA_EMAIL: LEAD_STAGES.INTERESTED,
    REACHED_OUT: LEAD_STAGES.INTERESTED,
    OUTBOUND_CONTACT: LEAD_STAGES.INTERESTED,
    FIRST_CONTACT_MADE: LEAD_STAGES.INTERESTED,
    CONTACTED_TODAY: LEAD_STAGES.INTERESTED,
    CONTACTED_RECENTLY: LEAD_STAGES.INTERESTED,
    // Additional common status mappings
    NEW: LEAD_STAGES.INTERESTED,
    INITIAL_CONTACT: LEAD_STAGES.INTERESTED,
    PROSPECT: LEAD_STAGES.INTERESTED,
    HOT: LEAD_STAGES.INTERESTED,
    WARM: LEAD_STAGES.INTERESTED,
    ENGAGED: LEAD_STAGES.INTERESTED,
    APPLICATION_SUBMITTED: LEAD_STAGES.APPLIED,
    DOCUMENTATION_PENDING: LEAD_STAGES.IN_REVIEW,
    UNDER_REVIEW: LEAD_STAGES.IN_REVIEW,
    ACCEPTED: LEAD_STAGES.ADMITTED,
    COMPLETED: LEAD_STAGES.ENROLLED,
    FINALIZED: LEAD_STAGES.ENROLLED,
  };
